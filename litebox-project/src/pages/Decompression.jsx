...
const FileUploader = ({ onUpload }) => {
  ...
  return (
    <div
      className="border-dashed border-4 border-purple-400 rounded-3xl p-10 text-center space-y-4 bg-gradient-to-br from-violet-100 to-white shadow-2xl hover:scale-105 transition-transform duration-300"
      onDrop={handleDrop}
      onDragOver={(e) => e.preventDefault()}
      onClick={handleClick}
    >
      <Upload className="mx-auto w-12 h-12 text-purple-600 animate-bounce" />
...
const PageWrapper = ({ title, tagline, children }) => (
  <div className="max-w-3xl mx-auto p-6 space-y-6">
    <motion.h1
      className="text-4xl font-extrabold text-center text-purple-700 drop-shadow-md"
...
const DecompressionPage = () => {
  ...
  return (
    <PageWrapper
      title="DecompressIt!"
      tagline="Unpack the power – Bring your files back to life."
    >
      <Card className="rounded-3xl shadow-xl border-2 border-purple-200">
        <CardContent className="p-6">
          ...
          <ActionBar
            onStart={() => alert("Decompression started")}
